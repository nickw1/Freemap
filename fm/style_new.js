...
(function (MapCSS) {
    ...
    function restyle(style, tags, zoom, type, selector) {
        ...
        if (((type == 'node' && tags['railway'] == 'station') && zoom >= 13 && zoom <= 18)) {
            ...
            s_default['color'] = 'red';
            s_default['icon-image'] = '/fm/icons/rsmall.png';
        ...
        if (((type == 'node' && tags['amenity'] == 'pub') && zoom >= 14 && zoom <= 18)) {
            ...
            s_default['font-family'] = 'DejaVu Sans Book';
            s_default['text'] = MapCSS.e_localize(tags, 'name');
            s_default['icon-image'] = '/fm/icons/pub.png';
            s_default['allow-overlap'] = 'true';
            s_default['text-offset'] = 8;
            s_default['z-index'] = 10;
        }

        if (((type == 'node' && tags['amenity'] == 'cafe') && zoom >= 14 && zoom <= 18)) {
            s_default['text-color'] = 'black';
            s_default['font-weight'] = 'bold';
            s_default['font-size'] = '8';
            s_default['font-family'] = 'DejaVu Sans Book';
            s_default['text'] = MapCSS.e_localize(tags, 'name');
            s_default['icon-image'] = '/fm/icons/cafe.png';
            s_default['allow-overlap'] = 'true';
            s_default['text-offset'] = 8;
            s_default['z-index'] = 10;
        }

        if (((type == 'node' && tags['amenity'] == 'restaurant') && zoom >= 14 && zoom <= 18)) {
            s_default['text-color'] = 'black';
            s_default['font-weight'] = 'bold';
            s_default['font-size'] = '8';
            s_default['font-family'] = 'DejaVu Sans Book';
            s_default['text'] = MapCSS.e_localize(tags, 'name');
            s_default['icon-image'] = '/fm/icons/restaurant.png';
            s_default['allow-overlap'] = 'true';
            s_default['text-offset'] = 8;
            s_default['z-index'] = 10;
        }

        if (((type == 'way' && tags['highway'] == 'motorway') && zoom >= 14 && zoom <= 18) || ((type == 'way' && tags['highway'] == 'motorway_link') && zoom >= 14 && zoom <= 18)) {
        ...
        if (((type == 'way' && tags['highway'] == 'trunk') && zoom >= 14 && zoom <= 18) || ((type == 'way' && tags['highway'] == 'trunk_link') && zoom >= 14 && zoom <= 18)) {
        ...
        if (((type == 'way' && tags['highway'] == 'primary') && zoom >= 14 && zoom <= 18) || ((type == 'way' && tags['highway'] == 'primary_link') && zoom >= 14 && zoom <= 18)) {
        ...
        if (((type == 'way' && tags['highway'] == 'secondary') && zoom >= 14 && zoom <= 18) || ((type == 'way' && tags['highway'] == 'secondary_link') && zoom >= 14 && zoom <= 18)) {
        ...
        if (((type == 'way' && tags['highway'] == 'tertiary') && zoom >= 14 && zoom <= 18) || ((type == 'way' && tags['highway'] == 'tertiary_link') && zoom >= 14 && zoom <= 18)) {
        ...
        if (((type == 'way' && tags['highway'] == 'unclassified') && zoom >= 14 && zoom <= 18) || ((type == 'way' && tags['highway'] == 'unclassified_link') && zoom >= 14 && zoom <= 18)) {
        ...
        if (((type == 'way' && tags['highway'] == 'residential') && zoom >= 14 && zoom <= 18) || ((type == 'way' && tags['highway'] == 'service') && zoom >= 14 && zoom <= 18) || ((type == 'way' && tags['highway'] == 'residential_link') && zoom >= 14 && zoom <= 18) || ((type == 'way' && tags['highway'] == 'service_link') && zoom >= 14 && zoom <= 18)) {
            s_default['casing-color'] = '#999';
            s_default['casing-width'] = 1;
            s_default['color'] = 'white';
            s_default['width'] = 2;
        ...
        if (((type == 'way' && tags['highway'] == 'track') && zoom >= 14 && zoom <= 18) || ((type == 'way' && tags['highway'] == 'byway') && zoom >= 14 && zoom <= 18)) {
            s_default['color'] = 'white';
            s_default['width'] = 2;
            s_default['casing-color'] = '#999';
            s_default['casing-width'] = 1;
        ...
        if (((type == 'way' && tags['highway'] == 'path') && zoom >= 14 && zoom <= 18) || ((type == 'way' && tags['highway'] == 'footway') && zoom >= 14 && zoom <= 18) || ((type == 'way' && tags['highway'] == 'bridleway') && zoom >= 14 && zoom <= 18)) {
        ...
        if (((type == 'way' && (tags.hasOwnProperty('highway')) && tags['designation'] == 'public_footpath') && zoom >= 14 && zoom <= 18)) {
        ...
        if (((type == 'way' && (tags.hasOwnProperty('highway')) && tags['designation'] == 'public_bridleway') && zoom >= 14 && zoom <= 18)) {
        ...
        if (((type == 'way' && (tags.hasOwnProperty('highway')) && tags['designation'] == 'public_byway') && zoom >= 14 && zoom <= 18) || ((type == 'way' && (tags.hasOwnProperty('highway')) && tags['designation'] == 'byway') && zoom >= 14 && zoom <= 18) || ((type == 'way' && (tags.hasOwnProperty('highway')) && tags['designation'] == 'restricted_byway') && zoom >= 14 && zoom <= 18) || ((type == 'way' && (tags.hasOwnProperty('highway')) && tags['designation'] == 'byway_open_to_all_traffic') && zoom >= 14 && zoom <= 18) || ((type == 'way' && (tags.hasOwnProperty('highway')) && tags['designation'] == 'unknown_byway') && zoom >= 14 && zoom <= 18)) {
            s_rights['color'] = 'red';
            s_rights['width'] = 3;
            s_rights['opacity'] = 0.5;
            s_rights['z-index'] = 9;
        ...
        if (((type == 'way' && (tags.hasOwnProperty('highway')) && tags['foot'] == 'permissive') && zoom >= 14 && zoom <= 18)) {
            s_rights['color'] = 'cyan';
            s_rights['width'] = 3;
            s_rights['opacity'] = 0.5;
            s_rights['z-index'] = 9;
        ...
        if (((type == 'way' && tags['power'] == 'line') && zoom >= 14 && zoom <= 18)) {
        ...
        if (((type == 'way' && tags['railway'] == 'rail') && zoom >= 14 && zoom <= 18) || ((type == 'way' && tags['railway'] == 'preserved_rail')) || ((type == 'way' && tags['railway'] == 'preserved'))) {
            s_default['color'] = 'white';
