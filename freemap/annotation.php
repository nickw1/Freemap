...
{
    case 'create':
		$cleaned['dir'] = (isset($cleaned['dir']))?$cleaned['dir']:0;
        if($cleaned['ways'])
        {
        ...
        {
			if(isset($cleaned['proj']) && $cleaned['proj']=="4326")
			{
				// convert lon/lat to spherical mercator "Google"
				$cleaned['x'] = lon_to_sphmerc($cleaned['x']);
				$cleaned['y'] = lat_to_sphmerc($cleaned['y']);
			}
