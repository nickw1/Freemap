...
public class ReportProblemActivity extends Activity{
	...
	public void onCreate(Bundle savedInstanceState)
	{
		...
		problemLat = intent.getExtras().getDouble("lat");
		problemLon = intent.getExtras().getDouble("lon");
		...
		ok.setOnClickListener(new View.OnClickListener()
		{
			public void onClick(View v)
			{
				if(rowDetails!=null)
				{
					...
					if(!prefs.getBoolean("noupload", false))
					{
						...
						postData.add(new BasicNameValuePair("y",String.valueOf(problemLat)));
						postData.add(new BasicNameValuePair("x",String.valueOf(problemLon)));
	...
	{
		sendBack(task.isSuccess(), false);
	}

	public void sendBack(boolean success, boolean needToCache)
	{
