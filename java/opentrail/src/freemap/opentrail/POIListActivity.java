...
public class POIListActivity extends ListActivity {
		...
		public void onCreate(Bundle savedInstanceState)
		{
			...
			if (Shared.pois != null && Shared.location != null)
			{
				pois= Shared.pois.getPOIsByType(keyval[0],keyval[1]);
				names = new String[pois.size()];
				types = new String[pois.size()];
				Point p = Shared.proj.project(new Point(Shared.location.getLongitude(),
			...
			{
				adapter = new ArrayAdapter<String>(this,android.R.layout.simple_list_item_1,new String[]{"location unknown"});
			}
